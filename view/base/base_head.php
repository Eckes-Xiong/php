...
<head>
    ...
    <link rel="stylesheet" href="/application/common/css/style.animate.css"/>
    <link rel="stylesheet" href="/application/common/css/style.base.css?v=<?=mt_rand(0,999999)?>"/>
    ...
    <meta name="description" content="<?=$this->html['h_description'];?>"/>
    <meta name="keywords" content="<?=$this->html['h_keyword'];?>"/>
